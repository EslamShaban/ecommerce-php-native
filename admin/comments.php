       ...
       if(isset($_SESSION['Username'])){ 
           ...
           if($do == 'Manage'){  
                  ...
                  $stmt = $con->prepare("SELECT 
                                               comments.*, items.Name AS Item_Name, users.Username AS Memeber
                                         FROM 
                                               comments
                              ...
                              <?php 
                                 ...
                                 foreach($comments as $comment){
                                     ...
                                     echo "<tr>";
                                         ...
                                         echo "<td>" . $comment['Memeber'] . "</td>";
                                         echo "<td>" . $comment['comment_date']  . "</td>";
                                         echo "<td>
                                         
                                                 <a href='comments.php?do=Edit&comid=" . $comment['c_id'] ."' class='btn btn-success'><i class='fa fa-edit'></i> Edit</a>
                                                 <a href='comments.php?do=delete&comid=" . $comment['c_id'] ."' class='confirm btn btn-danger'><i class='fa fa-close'></i> Delete</a> ";
